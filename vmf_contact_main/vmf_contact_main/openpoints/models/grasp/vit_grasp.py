...
File Description: Vision Transformer for Point Cloud Grasp
'''
from base64 import encode
import torch
import torch.nn as nn
from .head_grasp import SceneGraspHeadPointNet
...
class PointVitGrasp(nn.Module):
    def __init__(self,
        ...
        self.head = SceneGraspHeadPointNet(num_classes=num_classes, in_channels=fp_mlps[0][0])
